...
public class CacheCoherenceBenchmark {
    ...
    private static void benchmark_atomicInteger(String label, boolean sameCore) throws InterruptedException {
        ...
        System.out.println("Time taken: " + (endTime - startTime) + "ns  to count : "+ atomicCounter.get() + "\n");
    }

    private static void benchmark_longAdder(String label, boolean sameCore) throws InterruptedException {
        System.out.println("Benchmarking " + label + " with sameCore = " + sameCore);
        long startTime = System.nanoTime();
        CountDownLatch latch = new CountDownLatch(NUM_THREADS);
        ...
        latch.await();
        long endTime = System.nanoTime();
        System.out.println("Time taken: " + (endTime - startTime) + "ns  to count : "+ longAdder.longValue() + "\n");
    }
}
