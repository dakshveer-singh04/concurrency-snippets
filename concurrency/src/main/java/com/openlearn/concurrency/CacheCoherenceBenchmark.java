...
public class CacheCoherenceBenchmark {
  ...
  private static void benchmark_action(
      String label, boolean sameCore, Runnable action, Supplier<?> getValue)
    ...
    System.out.println(
        "Time taken: " + (endTime - startTime) + "ns  to count : " + getValue.get() + "\n");
  }
}
